...
export const Arbol = () => {
    ...
    const { fincas } = useSelector(state => state.ui);
                ...
                <Card >
                    <CardContent >
                        ...
                        >
                            ...
                            {fincas.map((finca) => (
                                <StyledTreeItem key={finca.id} nodeId={"'" + finca.id + "'"} 
                                labelText={finca.nombre} labelIcon={MailIcon}>
                                    <Hoja principal={finca.id} />
                                </StyledTreeItem>
                            ))}

                            {/* <StyledTreeItem nodeId="1" labelText="All Mail" labelIcon={MailIcon} />
                            <StyledTreeItem nodeId="2" labelText="Trash" labelIcon={DeleteIcon} /> */}
                            {/* <StyledTreeItem nodeId="3" labelText="Usuarios" labelIcon={SupervisorAccountIcon}> */}
